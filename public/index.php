...
<body style="background-color: #F4F1E9;">
    ...
    <body style="background-color: #F4F1E9;">
        <div class="caja-central">
            <div class="left-side">
                ...
                <p class="description-text mt-3">Discover the benefits of joining our platform. Stay connected and explore new opportunities with us.</p>
            </div>
    ...
    <style type="text/css">
        ...
        /* Divider line using pseudo-element */
        .caja-central::before {
            content: "";
            position: absolute;
            top: 0;
        ...
        /* Right side - Registration invitation */
        .right-side {
            width: 50%;
    ...
    <!--  <script src="../public/members/auth.js"></script>  -->
